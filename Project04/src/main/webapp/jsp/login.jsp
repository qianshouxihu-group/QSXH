...
<div class="nav-box">
    <div class="nav">
        <div class="nav">
            ...
            <a href="javascript:void(0);">条件搜索</a>
            <a href="javascript:void(0);">智能匹配</a>
    ...
    <div class="main-box1">
        ...
        <div class="login-right">
            ...
            <div class="main-log">
                ...
                <div class="main-pass-text">没有帐号？<a href="jsp/clientReg.jsp">免费注册</a><a href="" class="forget">忘记密码 &gt;</a></div>
            </div>
        </div>
    </div>
  </form>
