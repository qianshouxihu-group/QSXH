...
<%@ page import="com.qsxh.controller.*"%>
<%@ page import="com.alipay.api.*"%>
<%@ page import="com.alipay.api.internal.util.*"%>
<%@ page import="com.qsxh.utiles.AlipayConfig" %>
<%
	/* *
	 * 功能：支付宝服务器同步通知页面
	 * 日期：2017-03-30
...
<script type="text/javascript">
    $(function () {
        ...
        if(trade_no!=null&&trade_no!=''){
            location.href="${path}/AccountAction/rec.action?money="+money;
        }else {
            alert("充值失败");
        }
...
<input type="" value="<%=out_trade_no%>" id="trade_no">
<input type="" value="<%=total_amount%>" id="money">
</body>
</html>
