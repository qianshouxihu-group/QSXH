...
<%--            </table>--%>
<%--        </div>--%>
        <c:forEach items="${sysMsgList}" var="msg" varStatus="id">
            <option value="${msg.mtitle}">${msg.mtitle} </option>
            <option value="${msg.mcontext}">${msg.mcontext} </option>
            <option value="${msg.mtime}">${msg.mtime} </option>
            <option value="${msg.mstate}">${msg.mstate} </option>
        </c:forEach>
