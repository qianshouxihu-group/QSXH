...
<div class="main">
    <div class="main-box1">
        <div class="main-left"><!--left-->
            <div class="s-address">当前位置：<a href="">个人中心 </a>>Ta 的主页</div>
            <div class="s-top">
                <div class="preview">
...
<div class="layui-row" id="datingDiv" style="display: none;">
    <div class="layui-col-md10">
        <form class="layui-form" action="" method="post" id="datingForm">
            <%--            <input type="hidden" name="dtoid" value="" >&lt;%&ndash;value为TA的资料页面的用户id&ndash;%&gt;--%>

            <div class="layui-form-item">
                <label class="layui-form-label" style="padding-left:-50px;">接收人:</label>
                <div class="layui-input-block">
                    <input type="text" name = "dtoid" value="${requestScope.relationUser.ftoid}"
...
<div class="layui-row" id="messageDiv" style="display: none;">
    <div class="layui-col-md10">
        <form class="layui-form" action="" method="post" id="messageForm">
            <%--            <input type="hidden" name="mtoid" value="" >&lt;%&ndash;value为TA的资料页面的用户id&ndash;%&gt;--%>
            <div class="layui-form-item">
                <label class="layui-form-label" style="padding-left:-50px;">接收人:</label>
                <div class="layui-input-block">
                    <input type="text" name = "mtoid" value="${requestScope.relationUser.ftoid}"
                           readonly class="layui-input"/>
                </div>
            </div>
...
<script>
    ...
    function chatApply() {
        ...
        var chatid = '#'+ctoid;
        if (ctoid==$(".chatBox-list").children(chatid).val()){
            alert('对方已在聊天列表中！');
        }
        else if (confirm('是否发起聊天？')){
            sendMessage(uname,ctoid,'apply');
        }
    }
